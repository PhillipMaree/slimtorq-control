package Alva "Alva slotless PMSM motor model for FOC prototyping (Python-side encoder + controller)"

  model SlotlessPMSM_abc "Surface-PM slotless PMSM with abc-frame boundary for FMU export.
       ...
       Optional spatial-harmonic torque ripple multiplies the ideal dq torque."
    ...
    parameter Real torque_ripple_pct(unit = "1") = 0.0 "Ripple amplitude as fraction of T_e_dq (0.01 = 1%)";
    parameter Integer torque_ripple_order = 6 "Electrical-harmonic order (6 is standard for 3-phase PMSM)";
    parameter Real torque_ripple_phase(unit = "rad") = 0.0 "Ripple phase offset";
    // ---------- Initial conditions ----------
    ...
    Modelica.Blocks.Interfaces.RealOutput T_e(unit = "N.m") "Electromagnetic torque (true, includes ripple)" annotation(
  ...
  protected
    ...
    Real T_e_dq(unit = "N.m") "Ideal dq torque before ripple modulation";
  initial equation
    i_d = i_d0;
    i_q = i_q0;
    omega_m = omega_m0;
  ...
  equation
    ...
    // ---- Electromagnetic torque with spatial-harmonic ripple ----
    T_e_dq = 1.5*p*psi_m*i_q;
    T_e = T_e_dq*(1.0 + torque_ripple_pct*sin(torque_ripple_order*theta_e + torque_ripple_phase));
    // ---- Mechanical dynamics ----
    ...
    annotation(
      Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}), graphics = {
        ...
        Text(extent = {{-95, -70}, {-55, -90}}, textString = "T_L", horizontalAlignment = TextAlignment.Left),
        ...
        Text(extent = {{55, 40}, {95, 20}}, textString = "omega_m", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, 20}, {95, 0}}, textString = "theta_m", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, 0}, {95, -20}}, textString = "T_e", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, -20}, {95, -40}}, textString = "i_d", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, -40}, {95, -60}}, textString = "i_q", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, -60}, {95, -80}}, textString = "v_d", horizontalAlignment = TextAlignment.Right),
        Text(extent = {{55, -80}, {95, -100}}, textString = "v_q", horizontalAlignment = TextAlignment.Right)}));
  end SlotlessPMSM_abc;
